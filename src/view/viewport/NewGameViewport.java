...
public class NewGameViewport extends Viewport {
    ...
    protected void generateView() {
        int margin = 200;
        setupButton("resources/png/sorority_girl.png", sneak_button_, margin);
        setupButton("resources/png/frat_boy.png", smasher_button_, margin);
        setupButton("resources/png/nerd.png", summoner_button_, margin);
    }
