 ...
 * plus up to 4 interconnected child nodes for use in a tree structure which
 * represents the entire conversation.
 *
 * @author JohnReedLOL
 */
public class ConversationNodeWithChildren {
    ...
    /**
     * These are null when the conversation node has no reply nodes underneath
     * (or above) it.
     */
     ...
     *
     * @param conversation_node - the Node that this conversation tree element
     * wraps
     */
     ...
     * @param conversation_node - the Node that this conversation tree element
     * wraps
     * @param parent - the parent of this node in the tree. The node that leads
     * to this node in a conversation.
     */
