...
public class FirstLevelMapBuilder extends MapBuilder {
    ...
    public Tile[][] generateMap(int height, int width) {
        ...
        tiles[1][2].getMapObjects().add(new NPC(new Armory(),new Sack(), new SneakOccupation(), ClassicMovementBehavior.getInstance()));
        tiles[1][3].getMapObjects().add(new Avatar(new Armory(),new Sack(), new SneakOccupation(),ClassicMovementBehavior.getInstance()));
